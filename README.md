# Personal keymap for Reviung41 keyboard build
...
- **Firmware Support**: ZMK configuration
- **Ready to use**: ready to flash firmware
...
:memo: **Note**: Reviung41 uses ZMK firmware with GitHub Actions for automatic builds, so no sync script is needed.
